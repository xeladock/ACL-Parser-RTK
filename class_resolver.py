...
#             try:
#                 input_net = ipaddress.ip_network(ip_str, strict=False)
#                 input_ip = None  # Treat as network for strict mode
#             except ValueError:
#                 return False
#
#         if obj_name == "any":
...
#                     start_ip, end_ip = entry
#                     if strict_mode:
#                         if input_ip and start_ip == input_ip and end_ip == input_ip:
#                             return True
#                     else:
#                         if input_ip and start_ip <= input_ip <= end_ip:
#                             return True
#                 else:
#                     if strict_mode:
#                         if input_net and entry == input_net:
#                             return True
#                     else:
#                         if input_ip and input_ip in entry:
#                             return True
#                         if input_net and (input_net.subnet_of(entry) or entry.subnet_of(input_net) or input_net.overlaps(entry)):
#                             return True
#         elif obj_name in self.groups:
#             for entry in self._resolve_group(obj_name):
#                 if isinstance(entry, tuple):
